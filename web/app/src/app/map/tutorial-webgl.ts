...
function initShaderProgram(gl: WebGLRenderingContext, vsSource: string, fsSource: string): WebGLProgram {
    ...
    if (vertexShader === null || fragmentShader === null) {
        throw Error("failed to create shaders")
    }
...
function drawScene(gl: WebGLRenderingContext, programInfo: { attribLocations: { vertexPosition: number; }; program: WebGLProgram | null; uniformLocations: { projectionMatrix: WebGLUniformLocation | null; modelViewMatrix: WebGLUniformLocation | null; }; }, buffers: { position: WebGLBuffer | null; }) {
